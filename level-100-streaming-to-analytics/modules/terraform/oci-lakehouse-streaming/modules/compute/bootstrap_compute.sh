...
wget -P /home/opc https://github.com/paulchyz/OCI_Streaming_Pipeline/archive/refs/heads/master.zip
cd /home/opc
chown opc:opc master.zip
unzip master.zip
chown -R opc:opc OCI_Streaming_Pipeline-master
cd /home/opc/OCI_Streaming_Pipeline-master/level-100-streaming-to-analytics/modules/functions
