locals {
  ...
  data_science_model_display_name            = "${var.data_science_model_display_name}_${random_string.random.id}"
  data_science_model_deployment_display_name = "${var.data_science_model_deployment_display_name}_${random_string.random.id}"
}
