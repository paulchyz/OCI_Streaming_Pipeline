...
SELECT STREAM, TO_TIMESTAMP(KEY, 'YYYY-MM-DD HH24:MI:SS.FF') KEY, PARTITION, OFFSET, BATCH_TIMESTAMP, TO_TIMESTAMP(TIMESTAMP, 'YYYY-MM-DD HH24:MI:SS.FF') TIMESTAMP, EQUIPMENT_ID, VIBRATION_AMPLITUDE, VIBRATION_FREQUENCY, TEMPERATURE, HUMIDITY from STREAMDATA,
    JSON_TABLE (
...
SELECT STREAM, TO_TIMESTAMP(KEY, 'YYYY-MM-DD HH24:MI:SS.FF') KEY, PARTITION, OFFSET, BATCH_TIMESTAMP, TO_TIMESTAMP(TIMESTAMP, 'YYYY-MM-DD HH24:MI:SS.FF') TIMESTAMP, EQUIPMENT_ID, VIBRATION_AMPLITUDE, VIBRATION_FREQUENCY, TEMPERATURE, HUMIDITY from STREAMDATA,
    ...
    ) WHERE TO_TIMESTAMP(KEY, 'YYYY-MM-DD HH24:MI:SS.FF') > (SELECT MAX(KEY) FROM STREAMDATA_VIEW) - INTERVAL '10' MINUTE ORDER BY KEY DESC;
...
SELECT STREAM, TO_TIMESTAMP(KEY, 'YYYY-MM-DD HH24:MI:SS.FF') KEY, PARTITION, OFFSET, BATCH_TIMESTAMP, TO_TIMESTAMP(TIMESTAMP, 'YYYY-MM-DD HH24:MI:SS.FF') TIMESTAMP, EQUIPMENT_ID, VIBRATION_AMPLITUDE, VIBRATION_FREQUENCY, TEMPERATURE, HUMIDITY from STREAMDATA,
    ...
    ) WHERE TO_TIMESTAMP(KEY, 'YYYY-MM-DD HH24:MI:SS.FF') > (SELECT MAX(KEY) FROM STREAMDATA_VIEW) - INTERVAL '3' MINUTE ORDER BY KEY DESC;
