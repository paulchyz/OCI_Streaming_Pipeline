...
def handler(ctx, data: io.BytesIO=None):
    try:
        cfg = ctx.Config()
        json_collection_name = 	STREAMDATA
        processed_bucket = ST_bucket_6seo
        ordsbaseurl = https://mvdvitnosgjllaz-stajd6seo.adb.us-ashburn-1.oraclecloudapps.com/ords/
        schema = admin
        dbuser = admin
        dbpwd = BlackBerry99!
        modelendpoint = https://modeldeployment.us-ashburn-1.oci.customer-oci.com/ocid1.datasciencemodeldeployment.oc1.iad.amaaaaaawe6j4fqankebxj5pmuhrthr4cl4fqahptqp2kckqyecpkx3olmha/predict
